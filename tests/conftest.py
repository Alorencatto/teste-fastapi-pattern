...
# WARNING: Ensure imports from `teste_fastapi_pattern` comes after this line
from teste_fastapi_pattern import app, settings, db  # noqa
from teste_fastapi_pattern.cli import create_user, cli  # noqa
