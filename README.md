...
- 🎯 Entry points to execute your program using `python -m <teste_fastapi_pattern>` or `$ teste_fastapi_pattern` with basic CLI argument parsing.
...
---
# teste_fastapi_pattern

[![codecov](https://codecov.io/gh/Alorencatto/teste-fastapi-pattern/branch/main/graph/badge.svg?token=teste-fastapi-pattern_token_here)](https://codecov.io/gh/Alorencatto/teste-fastapi-pattern)
[![CI](https://github.com/Alorencatto/teste-fastapi-pattern/actions/workflows/main.yml/badge.svg)](https://github.com/Alorencatto/teste-fastapi-pattern/actions/workflows/main.yml)

Awesome teste_fastapi_pattern created by Alorencatto

## Install

from source
```bash
git clone https://github.com/Alorencatto/teste-fastapi-pattern teste_fastapi_pattern
cd teste_fastapi_pattern
make install
```
...
```bash
pip install teste_fastapi_pattern
```

## Executing

```bash
$ teste_fastapi_pattern run --port 8080
```

or

```bash
python -m teste_fastapi_pattern run --port 8080
```

or

```bash
$ uvicorn teste_fastapi_pattern:app
```

## CLI

```bash
❯ teste_fastapi_pattern --help
Usage: teste_fastapi_pattern [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ teste_fastapi_pattern create-user --help
Usage: teste_fastapi_pattern create-user [OPTIONS] USERNAME PASSWORD
...
```bash
teste_fastapi_pattern create-user admin admin --superuser
```
...
Run with `teste_fastapi_pattern run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `teste_fastapi_pattern create-user`.
...
-----------------------------------------------------
teste_fastapi_pattern/__init__.py              4      0   100%
teste_fastapi_pattern/app.py                  16      1    94%
teste_fastapi_pattern/cli.py                  21      0   100%
teste_fastapi_pattern/config.py                5      0   100%
teste_fastapi_pattern/db.py                   10      0   100%
teste_fastapi_pattern/models/__init__.py       0      0   100%
teste_fastapi_pattern/models/content.py       47      1    98%
teste_fastapi_pattern/routes/__init__.py      11      0   100%
teste_fastapi_pattern/routes/content.py       52     25    52%
teste_fastapi_pattern/routes/security.py      15      1    93%
teste_fastapi_pattern/routes/user.py          52     26    50%
teste_fastapi_pattern/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in teste_fastapi_pattern/default.toml.
